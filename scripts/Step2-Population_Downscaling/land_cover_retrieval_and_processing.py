...
Processing Pipeline:
    ...
    Step 2: Classify features into categories (residential, education, leisure, c&i, other)

Classification Categories:
    - residential: Housing and accommodation facilities
    - education: Educational institutions
    - leisure: Recreation, entertainment, and religious facilities  
    - c&i (Commercial & Industrial): Business, industrial, and public services (also as work place)
