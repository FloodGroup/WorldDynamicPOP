...
DEFAULT_EHP_WEIGHTS = {
    ...
    'c&c':         [1.9, 1.3, 1.0, 1.1, 1.9, 3.6, 8.4, 16.3, 27.3, 33.3, 37.5, 38.2,
...
class PopulationDownscaler:
    ...
    def load_external_weights(self, csv_path: Path) -> None:
        ...
        for col in df.columns:
            ...
            elif 'c&c' in c or 'com' in c: col_map[col] = 'c&c'
    ...
    def _normalize_category(self, category: Any) -> str:
        ...
        if 'c&c' in cat or 'commercial' in cat: return 'c&c'
    ...
    def _compute_effective_area(
        ...
        category_grid[valid_mask] = cfg.category_codes['c&c']
...
def main():
    ...
    parser.add_argument('--alpha_cc', type=float, default=0.91,
                        help="Floor area coefficient for c&c (default: 0.91)")
